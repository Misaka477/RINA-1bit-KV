"""Test iterative MLP denoising on KVR output."""
import os, sys, torch
...
for denoise in [0, 1, 3, 5]:
    ...
    print(f"denoise={denoise}: {'PASS' if acc else 'FAIL'} {txt[:60]}")
